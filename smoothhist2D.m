function [ctrs1, ctrs2, F] = smoothhist2D(X,lambda,nbins,outliercutoff,plottype)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% LMO: add fix for when bin contains zero
% 23jul2015
k = find(bin(:) < 1);
bin(k) = 1;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
switch plottype
    ...
    case 'image'
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % LMO: add fix for 0,0 being in lower left corner
        % 23jul2015
        set(gca, 'YDir', 'normal');
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
